...
//atype[1] = [];
atype[1] = //'lt',
['t2_lt', 'tetrarch_ll', 'renaultft', 'd1', 'hotchkiss_h35', 'amx38', 'amx40', 'elc_amx', 'amx_12t', 'amx_13_75', 'amx_13_90', 'm22_locust', 'pzii_j', 'm24_chaffee', 't-50', 't_50_2', 'vk2801', 't-15', 'ms-1', 'ltraktor', 't1_cunningham', 't-26', 'bt-2', 'pzii', 'pz35t', 'm2_lt', 't-46', 'bt-7', 'pziii_a', 'pzii_luchs', 'pz38t', 'm3_stuart', 'a-20', 'vk1602', 'pz38_na', 'm5_stuart', 'm3_stuart_ll', 'ch02_type62', 'bt-sv', 't-127', 'valentine_ll', 'h39_captured', 'a-32']

atype[2] = //'mt', added panther_m10, pziv_schmalturm
...
if(fr_b!=0)insertNewTr(NatParent,(lang == "ru")?" Боев на французах:" :"Battles on France:", ""+fr_b+" ("+(fr_b/all_b*100).toFixed(0)+"%/"+col(fr_w/fr_b*100,0)+"%)" , (lang == "ru")?"Процент боев/Процент побед" : "battle procent/win procent");
if(uk_b!=0)insertNewTr(NatParent,(lang == "ru")?" Боев на бритах:" :"Battles on UK:", ""+uk_b+" ("+(uk_b/all_b*100).toFixed(0)+"%/"+col(uk_w/uk_b*100,0)+"%)" , (lang == "ru")?"Процент боев/Процент побед" : "battle procent/win procent");
